(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main")) new swiper_core_Swiper(".slider-main", {
        ...
        if (document.querySelector(".carousel__slider")) new swiper_core_Swiper(".carousel__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
